...
export default function StudentDetail() {
  ...
  return (
    <div className="p-6 md:p-10 pb-20">
      ...
      {/* Back Nav */}
      <Link to="/students" className="animate-fade-in-up inline-flex items-center gap-2 text-slate-500 hover:text-white transition-colors mb-8 text-sm font-medium group">
